...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonIcon(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          CheckboxW(const char* label, bool* v, ImColor Color, float Size);
    IMGUI_API bool          CheckboxTrue(const char* label, bool* v);
    IMGUI_API bool          CheckboxFalse(const char* label, bool* v);
    ...
    IMGUI_API bool          SliderFloatMain(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags, ImColor Color);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    ...
    IMGUI_API bool          SliderScalarMain(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImColor Color);
